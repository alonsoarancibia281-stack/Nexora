...
class _RegisterScreenState extends State<RegisterScreen> {
 ...
 DropdownButtonFormField<String>(initialValue:experience,items:['Principiante','Intermedio','Avanzado'].map((x)=>DropdownMenuItem(value:x,child:Text(x))).toList(),onChanged:(v)=>setState(()=>experience=v!),decoration:const InputDecoration(labelText:'Nivel de experiencia')),
