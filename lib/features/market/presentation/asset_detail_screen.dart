...
class _AssetDetailScreenState extends State<AssetDetailScreen> {
  ...
  void initState() {
    super.initState();
    candles = service.loadCandles(widget.symbol, interval);
  }
          ...
          children: [
            StreamBuilder<double>(
              ...
              builder: (context, snapshot) => Text(
                snapshot.hasData
                    ? '${snapshot.data!.toStringAsPrecision(8)} USDT'
                    : 'Conectando precio en tiempo real…',
              ...
              builder: (context, snapshot) {
                ...
                return Card(
                  child: Padding(
                    ...
                    child: CandlestickChart(candles: snapshot.data ?? const []),
                  ),
                );
              },
            ),
            ...
            const Card(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Próximo paso: análisis técnico', style: TextStyle(fontWeight: FontWeight.bold)),
                    SizedBox(height: 6),
                    Text('RSI, MACD, EMA, Bollinger, ATR, ADX, soportes y resistencias se incorporarán en la Fase 3 sobre estas velas reales.'),
                  ],
                ),
              ),
            ),
